...
def get_program_parameters():
    ...
    parser.add_argument(
        "--loss_data", type=str, default="loss_data.npz", help="loss data"
    )
    parser.add_argument(
        "--predicton_image_plot",
        type=str,
        default="prediction_image_plot.jpg",
        help="image_plot",
    )
    parser.add_argument("--predict_image_data", type=str, help="image_prediction")
...
if __name__ == "__main__":
    ...
    image_path = save_dir / args.predicton_image_plot
    plt.savefig(image_path)
